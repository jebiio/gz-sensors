 ...
 *
*/
#ifndef GZ_SENSORS_OpticalKARISENSOR_HH_
#define GZ_SENSORS_OpticalKARISENSOR_HH_
...
namespace gz
{
  namespace sensors
  {
    ...
    class OpticalKariSensorPrivate;
    ...
    class GZ_SENSORS_CAMERA_VISIBLE OpticalKariSensor : public RenderingSensor
    {
      /// \brief constructor
      public: OpticalKariSensor();

      /// \brief destructor
      public: virtual ~OpticalKariSensor();
      ...
      /// \brief Get the camera OpticalKari frame
      /// \return The camera OpticalKari frame
      ...
      /// \internal
      private: std::unique_ptr<OpticalKariSensorPrivate> dataPtr;
