...
class gz::sensors::MyCameraSensorPrivate
{
  /// \brief Save an image
...
//////////////////////////////////////////////////
bool MyCameraSensor::CreateCamera()
{
  ...
  else
  {
    ...
    auto projectionMatrix = MyCameraSensorPrivate::BuildProjectionMatrix(
        this->dataPtr->camera->ImageWidth(),
        this->dataPtr->camera->ImageHeight(),
        fx, fy, cx, cy, s,
...
//////////////////////////////////////////////////
MyCameraSensor::MyCameraSensor()
  : dataPtr(new MyCameraSensorPrivate())
{
}
...
//////////////////////////////////////////////////
bool MyCameraSensor::Init()
{
  return this->Sensor::Init();
}

//////////////////////////////////////////////////
bool MyCameraSensor::Load(const sdf::Sensor &_sdf)
{
  ...
  this->dataPtr->sceneChangeConnection =
      ...
      std::bind(&MyCameraSensor::SetScene, this, std::placeholders::_1));
...
//////////////////////////////////////////////////
bool MyCameraSensor::Load(sdf::ElementPtr _sdf)
{
...
/////////////////////////////////////////////////
gz::common::ConnectionPtr MyCameraSensor::ConnectImageCallback(
...
/////////////////////////////////////////////////
void MyCameraSensor::SetScene(gz::rendering::ScenePtr _scene)
{
  std::lock_guard<std::mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
bool MyCameraSensor::Update(const std::chrono::steady_clock::duration &_now)
{
...
//////////////////////////////////////////////////
void MyCameraSensor::OnTrigger(const gz::msgs::Boolean &/*_msg*/)
{
  std::lock_guard<std::mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
bool MyCameraSensorPrivate::SaveImage(const unsigned char *_data,
...
//////////////////////////////////////////////////
unsigned int MyCameraSensor::ImageWidth() const
{
  if (this->dataPtr->camera)
...
//////////////////////////////////////////////////
unsigned int MyCameraSensor::ImageHeight() const
{
  if (this->dataPtr->camera)
...
//////////////////////////////////////////////////
rendering::CameraPtr MyCameraSensor::RenderingCamera() const
{
  return this->dataPtr->camera;
}

//////////////////////////////////////////////////
std::string MyCameraSensor::InfoTopic() const
{
  return this->dataPtr->infoTopic;
}

//////////////////////////////////////////////////
bool MyCameraSensor::AdvertiseInfo()
{
...
//////////////////////////////////////////////////
bool MyCameraSensor::AdvertiseInfo(const std::string &_topic)
{
...
//////////////////////////////////////////////////
void MyCameraSensor::PublishInfo(
...
//////////////////////////////////////////////////
void MyCameraSensor::PopulateInfo(const sdf::Camera *_cameraSdf)
{
...
//////////////////////////////////////////////////
void MyCameraSensor::SetBaseline(double _baseline)
{
...
//////////////////////////////////////////////////
double MyCameraSensor::Baseline() const
{
  return this->dataPtr->baseline;
}

//////////////////////////////////////////////////
bool MyCameraSensor::HasConnections() const
{
  return this->HasImageConnections() || this->HasInfoConnections();
}

//////////////////////////////////////////////////
bool MyCameraSensor::HasImageConnections() const
{
...
//////////////////////////////////////////////////
bool MyCameraSensor::HasInfoConnections() const
{
  return this->dataPtr->infoPub && this->dataPtr->infoPub.HasConnections();
}

//////////////////////////////////////////////////
math::Matrix4d MyCameraSensorPrivate::BuildProjectionMatrix(
    double _imageWidth, double _imageHeight,
    double _intrinsicsFx, double _intrinsicsFy,
    double _intrinsicsCx, double _intrinsicsCy,
    double _intrinsicsS,
    double _clipNear, double _clipFar)
{
  return MyCameraSensorPrivate::BuildNDCMatrix(
           0, _imageWidth, 0, _imageHeight, _clipNear, _clipFar) *
           MyCameraSensorPrivate::BuildPerspectiveMatrix(
...
//////////////////////////////////////////////////
math::Matrix4d MyCameraSensorPrivate::BuildNDCMatrix(
    double _left, double _right,
    double _bottom, double _top,
    double _near, double _far)
{
...
//////////////////////////////////////////////////
math::Matrix4d MyCameraSensorPrivate::BuildPerspectiveMatrix(
    double _intrinsicsFx, double _intrinsicsFy,
    double _intrinsicsCx, double _intrinsicsCy,
    double _intrinsicsS,
    double _clipNear, double _clipFar)
