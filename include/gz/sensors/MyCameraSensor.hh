 ...
 *
*/
#ifndef GZ_SENSORS_MYCAMERASENSOR_HH_
#define GZ_SENSORS_MYCAMERASENSOR_HH_
...
#include "gz/sensors/mycamera/Export.hh"
...
namespace gz
{
  namespace sensors
  {
    ...
    class GZ_SENSORS_MYCAMERA_VISIBLE MyCameraSensor : public RenderingSensor
    {
      /// \brief constructor
      public: MyCameraSensor();

      /// \brief destructor
      public: virtual ~MyCameraSensor();
      ...
      /// \internal
      private: std::unique_ptr<MyCameraSensorPrivate> dataPtr;
