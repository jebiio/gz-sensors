 ...
 *
*/
#ifndef GZ_SENSORS_ICDSENSOR_HH_
#define GZ_SENSORS_ICDSENSOR_HH_

#include <memory>

#include <sdf/sdf.hh>
// #include "/home/jeyong/projects/kari/sdformat/include/sdf/sdf.hh"
...
namespace gz
{
  namespace sensors
  {
    ...
    class IcdSensorPrivate;

    /// \brief Imu Sensor Class
    ///
    /// An imu sensor that reports linear acceleration, angular velocity, and
    /// orientation
    class GZ_SENSORS_IMU_VISIBLE IcdSensor : public Sensor
    {
      /// \brief constructor
      public: IcdSensor();

      /// \brief destructor
      public: virtual ~IcdSensor();
      ...
      /// \internal
      private: std::unique_ptr<IcdSensorPrivate> dataPtr;
